"""Income — dividendos e juros do período.

Reconciliação: Σ dividendos/juros == total de income impresso.
"""
...
LAYOUT_HINTS = {
    ...
    "row_start": {"kind": "date"},
    "total_label_patterns": [r"^Total\s+Income", r"^Total\s+(Dividends|Interest)"],
